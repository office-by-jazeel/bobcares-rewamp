      ...
      <div className="absolute flex flex-col gap-8 items-start justify-end left-[180px] top-[337px] w-[903px] z-10">
        <div className="flex flex-col gap-10 items-start justify-center w-full">
          <h1 className="font-bold leading-[0.8] text-[96px] text-white tracking-[-1.92px] whitespace-pre-wrap">
            <span className="block mb-0">Get pro level help</span>
            <span className="block">from certified server experts</span>
          </h1>
          <div className="flex flex-col gap-6 items-start">
            <p className="font-normal leading-[1.5] text-[20px] text-white w-[508px] whitespace-pre-wrap">
              <span className="block mb-0">With expertise in Linux, Windows, and cloud-based servers, our engineers ensure</span>
              <span className="block"> your systems are fully optimized and aligned with your business goals</span>
            </p>
              ...
              <div className="flex gap-[34px] items-center">
                <div className="flex gap-4 items-center">
                  <div className="flex gap-[10px] items-center">
                    ...
                    <span className="font-normal text-[20px] text-white tracking-[-1px]">Google</span>
                  </div>
                  <div className="flex gap-[5px] items-center">
                    ...
                    <span className="font-normal text-[20px] text-white tracking-[-1px]">4.8</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-center">
                  <div className="flex gap-[10px] items-center">
                    <div className="relative rounded-full size-7">
                      <span className="text-white text-xl">⭐</span>
                    </div>
                    <span className="font-normal text-[20px] text-white tracking-[-1px]">Clutch</span>
                  </div>
                  <div className="flex gap-[5px] items-center">
                    {[...Array(4)].map((_, i) => (
                      <svg key={i} className="size-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="font-normal text-[20px] text-white tracking-[-1px]">4.5</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex gap-4 items-start">
          <button className="bg-[#0073ec] flex items-center justify-center px-[38px] py-5 rounded-[45px] hover:bg-[#005bb5] transition-colors">
            <span className="font-medium text-[20px] text-white tracking-[-1px]">View Our Portfolio</span>
          </button>
          <button className="border border-solid border-white flex items-center justify-center px-[38px] py-5 rounded-[45px] hover:bg-white/10 transition-colors">
            <span className="font-medium text-[20px] text-white tracking-[-1px]">Free Consultation</span>
          </button>
        </div>
      </div>
    </section>
