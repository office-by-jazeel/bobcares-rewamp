  ...
  return (
    <section
      ...
      <button
        ...
        className="absolute bottom-5 max-md:left-5 md:right-24 z-10 backdrop-blur-md border border-white/20 border-solid flex items-center justify-center p-3 md:p-5 rounded-[45px] md:size-[60px] hover:bg-black/10 transition-all"
